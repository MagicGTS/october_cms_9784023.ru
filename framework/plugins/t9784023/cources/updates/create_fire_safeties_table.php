...
/**
 * CreateFireSafetiesTable Migration
 */
class CreateFireSafetiesTable extends Migration
{
    public function up()
    {
        Schema::create('t9784023_cources_fire_safeties', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('t9784023_cources_fire_safeties');
    }
}
