    ...
    $(document).render(function(){
        ...
        $('select.custom-select').each(function(){
            ...
            if ($element.hasClass('select-no-dropdown')) {
                ...
                extraOptions.selectionCssClass += ' select-no-dropdown';
            }
            ...
            if ($element.hasClass('select-dropdown-auto-width')) {
                extraOptions.dropdownAutoWidth = true;
            }

            // Sizing
            if ($element.hasClass('form-control-sm')) {
                extraOptions.containerCssClass += ' form-control-sm';
            }

            if ($element.hasClass('form-control-lg')) {
                extraOptions.containerCssClass += ' form-control-lg';
            }
            ...
            $element.data('select2').$container.addClass(extraOptions.containerCssClass);
